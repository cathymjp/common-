...
def resize_image(image):
    ...
    print("center of image: " + str(width/2) + ", " + str(height/2))
...
def grab_contour(threshold_image):
    ...
    # print("center_points[0][0]", center_points[0][0])
    # print("center_points[1][0]", center_points[1][0])
    print("testing distance to camera 2:", distance_to_camera(22.5, focal_length, (center_points[0][0] - center_points[1][0])))

    # print("center points2", center_points)
    ...
    if corners[1][0][0] <= corners[2][0][0]:
        ...
        corners[2] = corners[1]
        corners[1] = tmp
    cv2.circle(threshold_image, (corners[0][3][0], corners[0][3][1]), 1, (100, 100, 100), thickness=7, lineType=8, shift=0)
    cv2.imshow("corenr[0][3][0]", threshold_image)
    cv2.circle(threshold_image, (corners[1][0][0], corners[1][0][1]), 1, (100, 100, 100), thickness=10, lineType=8, shift=0)
    cv2.imshow("second", threshold_image)
...
def marker_calculation():
    reference_marker_image = cv2.imread('images/1016_1m_transL_0.jpg')
    moved_marker_image = cv2.imread('images/1016_1m_transL_10.jpg')
    ...
    # print("w1- ref", ref_center[1][0] - ref_center[0][0])
    # print("w2 - ref", ref_center[3][0] - ref_center[2][0])
    # print("h1 - ref", ref_center[2][1] - ref_center[0][1])
    # print("h2 - ref", ref_center[3][1] - ref_center[1][1])
    # print("w1 - moved", moved_center[1][0] - moved_center[0][0])
    # print("w2 - moved", moved_center[3][0] - moved_center[2][0])
    # print("h1 - moved", moved_center[2][1] - moved_center[0][1])
    # print("h2 - moved", moved_center[3][1] - moved_center[1][1])
    ...
    print("ref_corners[2][3][1]- center_x", ref_corners[2][3][0] - center_X)
    ...
    print("ref_corners[2][3][1]- center_Y", ref_corners[2][3][1]- center_Y)
    ...
    print("testing negativity", math.degrees(math.atan(-36 / -90)))
    ...
    print("test angle 2", test_angle2)
    print("test angle diff", test_angle - test_angle2)
    ...
    print("moved_tangents_test: ", moved_tangents_test)
